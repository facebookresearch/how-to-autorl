    ...
    def update(self, rollouts):
        ...
        for e in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                ...
                _, adv, _, action_log_probs, dist_entropy = self.actor_critic.evaluate_actions(obs_batch, actions_batch)
                ...
                (adv_loss * self.adv_loss_coef + action_loss - dist_entropy * self.entropy_coef).backward()
        ...
        return adv_loss_epoch, value_loss_epoch, action_loss_epoch, dist_entropy_epoch
